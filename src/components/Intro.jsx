  ...
  return (
    <div className=' w-[100vw] h-[60vh] flex justify-center gap-[10%] items-center'>
        <div className=' w-[30%] flex flex-col justify-center items-center gap-5'>
            <span className=' text-5xl font-medium'>Download and use it on your phone</span>
            <span className=' text-gray-400 text-sm mb-10'>Immediately download Magic Post for free on your cellphoe, don't let you miss the promo promos that are offered because we always share interesting promos</span>
