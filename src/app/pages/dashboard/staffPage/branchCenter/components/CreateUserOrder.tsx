						...
						<div className=" w-[60vw] py-5 bg-white rounded-md flex flex-col justify-center items-center relative">
							...
							<div className="w-[40vw] rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
								<div className="p-5 space-y-4 md:space-y-6 sm:p-8">
									...
									<form
										className="space-y-4 md:space-y-6 grid items-end justify-center grid-cols-2 gap-2"
										action="#">
										<div>
										...
										<div>
											...
											<input
												type="text"
												onChange={(e) =>
													dispatch(updateCustomInstruction(e.target.value))
												}
										...
										<Link
											href={
												'/pages/dashboard/staffPage/branchCenter/user-Order'
											}
											className="w-full hover:bg-transparent hover:text-[#F79132] hover:border-1 hover:border-[#F79132] bg-[#F79132] text-white  hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
											Generate Bill
										</Link>
									</form>
								</div>
