...
const UserOrder = ({orderNumber}) => {
    ...
    console.log('day', day)
    console.log('datacheck', dataBranch)
  ...
  return (
	<div className=' flex justify-center items-center'>			
				...
				<button onClick={() => handlePrint()} className=' px-5 py-2 bg-orange-400 rounded-lg cursor-pointer text-white hover:bg-transparent hover:border-1 hover:border-orange-400 hover:text-orange-400'>
					Print Form
				</button>			
			</div>
  		)
