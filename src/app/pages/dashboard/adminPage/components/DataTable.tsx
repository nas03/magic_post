...
import { DataGrid, GridRowsProp, GridColDef, GridActionsCellItem, GridRowId } from '@mui/x-data-grid';
...
import {updateNameAdmin, updateIDAdmin, updateLocationAdmin, updateTypeAdmin} from '../../../../context/actions/updateDataAdmin'
...
// 	  rows = tableData.map((location: Location, index:any) => ({
// 		  id: index + 1,
// 		  col1: location.id,
// 		  col2: location.name,
