      ...
      <div id="home" className=' w-[100vw] h-[100vh] flex flex-col relative '>
        ...
        <div className=' absolute w-[100%] h-[25%] flex justify-between p-[2%]'>
              ...
              <ModalContent>
                {(onClose) => (
                  <>
                    <ModalHeader className="flex flex-col gap-1">QR code of your order</ModalHeader>
                    <ModalBody>
        ...
        <div className=' flex p-[6%] w-[100vw] h-[80%] absolute justify-between items-center bottom-0 '>
            <div className=' text-white w-[30%] gap-[5%] flex-col flex'>
                ...
                <div className=' h-[95%] justify-center items-center flex'>
                    <input onChange={(e) => setOrderNumber(e.target.value)} value={orderNumber} className=" max-lg:text-sm max-md:text-xs pl-2 appearance-none bg-white rounded-l-xl text-gray-700 h-[5vh] w-[70%] leading-tight focus:outline-none border-medium border-teal-500" type="text" placeholder="Search your order" aria-label="Full name"/>
                    <button onClick={() => handleSubmit()} className=' max-lg:text-sm max-md:text-xs w-[30%] h-[5vh] rounded-r-xl text-center bg-[#029827]'>Search Now</button>
                </div>
            </div>
